    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-slate-950 overflow-hidden">
      <header className="absolute top-0 w-full p-6 z-10 flex justify-between items-start">
        ...
        <nav className="flex gap-6">
          <a href="/" className="px-6 py-2 rounded-full bg-amber-500/20 text-amber-500 border border-amber-500/50 hover:bg-amber-500 hover:text-white transition-all font-medium backdrop-blur-md">
            Read The History
          </a>
        </nav>
      </header>
